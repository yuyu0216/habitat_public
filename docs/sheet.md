...
| red-egg-attack | 卵攻擊 | red | | | | breed | AM | -999 |
...
> ⚠️ **遊戲為 5 回合**:`round_eq:6` 以上的事件永遠不會觸發。下表把原本第 6 回合的「生態崩潰」收尾併進第 5 回合(`round_eq:5`),讓最後一回合成為人類釀成的總崩潰。

| event_id | name | trigger | 類型 | target_habitat | target_species | effect_type | effect_value | polution | message |
|---|---|---|---|---|---|---|---|---|---|
| DEV_ROAD_R1 | 道路開闢 | round_eq:1 | A | forest | yellow,blue,purple | reduce_pct | 10 | 0.05 | 森林外圍開始修路，機具聲趕走了原本的住戶。 |
| DEV_FARM_R1 | 農藥噴灑 | round_eq:1 | A | wetland | yellow,blue,purple | reduce_pct | 10 | 0.08 | 農田噴灑農藥，水源變得刺鼻。 |
| DEV_SEWAGE_R2 | 家庭廢水 | round_eq:2 | A | wetland | aqua | reduce_pct | 15 | 0.10 | 上游廢水排放增加，水質肉眼可見變濁。 |
| DEV_LOG_R3 | 林木砍伐 | round_eq:3 | A | forest | `<any>` | reduce_pct | 20 | 0 | 大片樹木被砍走，棲地變得炙熱乾燥。 |
| DEV_FACTORY_R4 | 工廠廢水 | round_eq:4 | A | wetland | aqua | reduce_pct | 25 | 0.20 | 工廠排放廢水，水源染上異色。 |
| DEV_POLLUTE_R5 | 埤塘汙染 | round_eq:5 | A | pond | `<any>` | reduce_pct | 30 | 0.25 | 埤塘湧入大量污水，水面浮起一層異色油膜。 |
| DEV_COLLAPSE_R5 | 生態崩潰 | round_eq:5 | A | `<any>` | `<any>` | reduce_pct | 35 | 0.20 | 人類的開發讓生態系統崩潰。 |
